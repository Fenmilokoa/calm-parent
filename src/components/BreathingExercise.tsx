  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center" aria-hidden>
        {/* Outer pulse ring */}
        <div
          className="absolute rounded-full bg-emerald-900/20 transition-transform duration-[800ms] ease-in-out"
          style={{
            width: "min(60vw, 60vh)",
        ...
        {/* Mid ring */}
        <div
          className="absolute rounded-full bg-emerald-800/30 transition-transform duration-[600ms] ease-in-out"
          style={{
            width: "min(60vw, 60vh)",
            height: "min(60vw, 60vh)",
        ...
        {/* Core orb */}
        <div
          className="relative rounded-full bg-emerald-700/60 transition-transform duration-[400ms] ease-in-out"
          style={{
            width: "min(60vw, 60vh)",
            height: "min(60vw, 60vh)",
      ...
      <div className="mt-12 text-center">
        <p className="text-2xl font-light tracking-widest text-emerald-200/80 uppercase">
          {phaseLabel}
        </p>
        <p className="mt-1 text-sm text-emerald-500/60 tabular-nums">
          {countdown}
        </p>
      </div>
